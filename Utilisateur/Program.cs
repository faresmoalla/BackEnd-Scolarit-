...
/*
var connectionString =  builder.Services.AddDbContext<UserDbContext>
   (opt => opt.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection"), p => p.MigrationsAssembly("Test")));
*/
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("swagger/v1.0/swagger.json", "SPLIT API v0.4");
